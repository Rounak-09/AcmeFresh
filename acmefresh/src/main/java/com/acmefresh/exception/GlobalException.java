...
public class GlobalException {
	...
	public ResponseEntity<ErrorDetails> myExpHandler(VegetableException ie, WebRequest wr){
		System.out.println("VegetableException");
	...
	public ResponseEntity<ErrorDetails> myExpHandler(ProductException ie, WebRequest wr){
	...
	public ResponseEntity<ErrorDetails> myExpHandler(CartException ie, WebRequest wr){
		System.out.println("CartException");
